...
WS.stages = [
   ...
   * ══════════════════════════════════════════════════ */
  {
    ...
    briefing: [
      ...
      { text: '[경고] ████ 전투로봇 조립 공장 SCADA 비상 ████', 'class': 'error', delay: 500 },
      { text: '[경고] Gashiga APT Group - OT 네트워크 침투 확인', 'class': 'error', delay: 300 },
      { text: '[경고] 공장 제어 시스템(PLC/HMI) 이상 징후 다수 감지', 'class': 'error', delay: 300 },
      { text: '', 'class': '' },
      { text: '[단장] ...{name}, 들리나?', 'class': 'commander', delay: 600 },
      { text: '[단장] 아직 긴장을 풀 때가 아니었어.', 'class': 'commander', delay: 400 },
      { text: '[단장] 포렌식에서 발견한 SCADA 공격 계획... 이미 실행에 옮겨졌다.', 'class': 'commander', delay: 400 },
      { text: '', 'class': '' },
      { text: '[단장] 대상은 우리 전투로봇 조립 공장이야.', 'class': 'commander', delay: 300 },
      { text: '[단장] 공장의 PLC 제어 시스템이 Modbus 프로토콜로 조작되고 있고,', 'class': 'commander', delay: 300 },
      { text: '[단장] HMI 대시보드가 변조되어 운영자들이 정상으로 오인 중이다.', 'class': 'commander', delay: 300 },
      { text: '[단장] 놈들의 목표는 플라즈마 코어 과열로 공장 전체를 날리는 것이야.', 'class': 'commander', delay: 400 },
      { text: '', 'class': '' },
   ...
   * ══════════════════════════════════════════ */
  {
    ...
    briefing: [
      ...
      { text: '', 'class': '' },
      { text: '═══════════════════════════════════════════════════════', 'class': 'success' },
      { text: '  OPERATION: WHITE SHIELD & IRONCLAD - 작전 완료', 'class': 'success' },
      { text: '═══════════════════════════════════════════════════════', 'class': 'success' },
      ...
      { text: '│                                                    │', 'class': 'objective' },
      { text: '│  ── ACT 1: Operation White Shield ──               │', 'class': 'objective', speed: 10 },
      ...
      { text: '│                                                    │', 'class': 'objective' },
      { text: '│  ── ACT 2: Operation Ironclad ──                   │', 'class': 'objective', speed: 10 },
      ...
      { text: '│                                                    │', 'class': 'objective' },
      { text: '│  위협 그룹: Gashiga APT Group                      │', 'class': 'error', speed: 10 },
      { text: '│  상태: IT 인프라 + OT/SCADA 시스템 방어 완료         │', 'class': 'success', speed: 10 },
      { text: '│                                                    │', 'class': 'objective' },
      ...
      { text: '', 'class': '' },
      { text: '  ── ACT 2: SCADA/OT 방어 ──', 'class': 'objective', speed: 15 },

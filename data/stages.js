   ...
   * ══════════════════════════════════════════ */
  {
    ...
    commands: [
      ...
      },
      {
        id: 'history',
        exact: 'history',
        alts: ['history', 'cat ~/.bash_history', 'cat /root/.bash_history'],
        keywords: ['history'],
        pattern: '^(history|cat\\s+.*\\.bash_history)',
      },
    ],
    interstitial: {
      lastb: [
    ...
    commands: [
      {
        ...
        keywords: ['shadow'],
        pattern: '(sudo\\s+)?(cat|less|more|head|tail)\\s+/etc/shadow',
      },
      {
        id: 'chage_policy',
    ...
    commands: [
      {
        ...
        pattern: '(sudo\\s+)?ps\\s+(-ef|aux)\\s*\\|\\s*grep\\s+coolant_valve',
        wrongFeedback: {
      ...
      },
      {
        ...
        keywords: ['kill', '7782'],
        pattern: '(sudo\\s+)?kill\\s+(-9|-SIGKILL|-KILL)\\s+7782',
        wrongFeedback: {
